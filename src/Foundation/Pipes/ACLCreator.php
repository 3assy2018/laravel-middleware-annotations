...
class ACLCreator
{
    ...
    {
        $annotationScanner->results = array_merge(...array_map(function ($key, $values){
            return [$key => array_unique($values)];
        }
        ,array_keys($annotationScanner->results), array_values($annotationScanner->results)));
